          ...
          <div className="flex flex-col items-center lg:w-5/9 lg:items-start justify-center space-y-3 lg:space-y-2">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-zinc-800 bg-zinc-900/80 px-4 py-1.5 text-zinc-400 backdrop-blur-md">
              <span className="relative flex h-2 w-2">
                <span className={`animate-ping absolute inline-flex h-full w-full rounded-full ${details.statuses.work ? "bg-green-400" : "bg-red-400" } opacity-75`}></span>
                <span className={`relative inline-flex rounded-full h-2 w-2 ${details.statuses.work ? "bg-green-500" : "bg-red-500"}`}></span>
              </span>
              <span className="tracking-wide text-xs font-lexend capitalize">
                {details.statuses.work ? "Available for work" : "Currently employed"}
              </span>
            </div>
            {/* Role */}
