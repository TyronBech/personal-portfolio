...
const FolderCard: React.FC<FolderCardProps> = ({ project }) => {
  return (
    <div style={{ willChange: "transform" }} className="group relative w-full h-full items-center min-h-112.5 bg-[#18181b] rounded-3xl overflow-hidden transition-transform duration-300 hover:-translate-y-3 flex flex-col border border-zinc-800/50">
